...
public class TextUtil
{
    ...
    /// <summary>
    /// 专门用来处理拆分道具组信息的方法 以int返回
    /// </summary>
    /// <param name="str"> 待拆分的字符串 </param>
    /// <param name="typeOne"> 组间分隔符 拆分字符类型：1-; 2-, 3-% 4-: 5-空格 6-| 7-_ </param>
    ...
    /// <summary>
    /// 专门用来拆分多种键值对形式的数据的 以string返回
    /// </summary>
    /// <param name="str"> 待拆分的字符串 </param>
    /// <param name="typeOne"> 组间分隔符 拆分字符类型：1-; 2-, 3-% 4-: 5-空格 6-| 7-_ </param>
    /// <param name="typeTwo"> 键值对分隔符 拆分字符类型：1-; 2-, 3-% 4-: 5-空格 6-| 7-_ </param>
    /// <param name="callBack"> 回调函数 </param>
    ...
    /// <returns> n亿n千万 或 n万n钱 或 1000 3434 234 </returns>
